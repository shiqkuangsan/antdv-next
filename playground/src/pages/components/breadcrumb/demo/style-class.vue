<docs lang="zh-CN">
通过 `classes` 和 `styles` 传入对象/函数可以自定义 Breadcrumb 的[语义化结构](#semantic-dom)样式。
</docs>

<docs lang="en-US">
You can customize the [semantic dom](#semantic-dom) style of Breadcrumb by passing objects/functions through `classes` and `styles`.
</docs>
